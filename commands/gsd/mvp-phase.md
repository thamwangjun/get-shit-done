...
<execution_context>
!`cat $HOME/.claude/get-shit-done/workflows/mvp-phase.md`
!`cat $HOME/.claude/get-shit-done/references/spidr-splitting.md`
!`cat $HOME/.claude/get-shit-done/references/user-story-template.md`
</execution_context>
