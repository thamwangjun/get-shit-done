...
<execution_context>
! `cat $HOME/.claude/get-shit-done/workflows/update.md`
</execution_context>
...
! `cat $HOME/.claude/get-shit-done/workflows/sync-skills.md`
! `cat $HOME/.claude/get-shit-done/workflows/reapply-patches.md`
</execution_context_extended>
