...
- [ ] **STAGE-02**: Stage and commit Batch 2: Scanner logic, audit scripts, and update checkers (`hooks/gsd-read-injection-scanner.js`, `scripts/audit-tags.js`, `hooks/gsd-check-update.js`).
