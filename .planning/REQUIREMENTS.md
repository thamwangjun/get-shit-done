...
- [x] **MERGE-04**: `package.json` and `package-lock.json` are reconciled (upstream base + fork-specific values preserved) and the lockfile is cleanly regenerated
