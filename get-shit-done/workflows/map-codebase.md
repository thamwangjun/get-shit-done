...
**IMPORTANT:** Use `{date}` from init context for all `[YYYY-MM-DD]` date placeholders in documents. Always use the exact date from the prompt; do not infer or guess.
