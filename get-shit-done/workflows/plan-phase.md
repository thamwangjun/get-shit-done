...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  ...
  $GSD_SDK gap-analysis --phase-dir "${PHASE_DIR}" --phase-req-ids "$($GSD_SDK query init.plan-phase "$PHASE" --pick phase_req_ids 2>/dev/null || echo TBD)"
fi
```
