...
UI_AUDITOR_MODEL_effort_arg=$($GSD_SDK query resolve-model-effort gsd-ui-auditor --raw 2>/dev/null || echo "")
```
...
Agent(
  ...
  effort={UI_AUDITOR_MODEL_effort_arg}  # omit this line when UI_AUDITOR_MODEL_effort_arg == null
